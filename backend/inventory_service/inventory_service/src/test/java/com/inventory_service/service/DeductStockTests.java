...
class DeductStockTests {
    ...
    @Nested
    @DisplayName("Deduct Stock Tests")
    class DeductStockTestCases {
        ...
        void deductStock_inactiveInstructor() {
        ...
        void deductStock_componentNotFound() {
        ...
        void deductStock_inactiveComponent() {
        ...
        @Test
        @DisplayName("Should fail when stock insufficient")
        void deductStock_insufficientStock() {
            ...
            assertEquals(
                    "Insufficient stock for component: ESP32",
                    ex.getMessage()
            );
        ...
        void deductStock_updatedByValidation() {
        ...
        void deductStock_historyValidation() {
